...
<form action="certificateInfo/addBatch" id="addForm" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input name="fromNum" class="form-control">
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label">终止编号</label>
		<div class="col-sm-8">
			<input name="toNum" class="form-control">
		</div>
	</div>
