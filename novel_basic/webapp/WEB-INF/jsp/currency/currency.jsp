...
<body>
	...
	<div class="container-fluid">
		...
		<div class="right-content">
			...
			<div class="lujing">
               <span class="zhucaidan">币种管理</span>
               <span class="jiantou">&lt;&lt;</span>
               <span class="zicaidan">币种管理</span>
			</div>
		 	<div class="handleBtn">
			...
			<table class="table table-bordered table-striped table-hover myTable">
				...
				<tbody>
					<c:forEach var="curency" items="${currencies}">
						<tr>
							<td><input name="marked" type="checkbox" value="${curency.id}" /></td>
							<td>${curency.currencyCode}</td>
							<td>${curency.currencyName}</td>
						</tr>
					</c:forEach>
               </tbody>
           </table>
